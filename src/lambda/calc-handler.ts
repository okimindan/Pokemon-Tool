...
async function buildCalcInputFromSimpleRequest(body: SimpleCalcRequest): Promise<DamageCalcInput> {
  ...
  return {
    attacker: {
      ...
      nature: (body.attackerNature ?? "Hardy") as any,
      ...
      status: (body.attackerStatus ?? "none") as any,
    ...
    defender: {
      ...
      nature: (body.defenderNature ?? "Hardy") as any,
      ...
      status: (body.defenderStatus ?? "none") as any,
